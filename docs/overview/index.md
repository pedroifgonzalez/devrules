...
Welcome to the DevRules documentation! This index will help you find exactly what you need.
...
- **[Context-Aware Documentation Benefits](../developers/context-aware-docs-benefits.md)** (508 lines)
...
📊 **Business Case & ROI:**
- [One-Pager](../decision-makers/one-pager.md) - Quick pitch (5 min read)
- [Company Impact Table](../decision-makers/one-pager.md#company-impact)
- [ROI Comparison](../decision-makers/comparison.md#roi-comparison)
- [Real-World Scenario ROI](../developers/scenario-context-aware-docs.md#roi-calculation)

💼 **Enterprise Features:**
- [Enterprise Customization](../decision-makers/one-pager.md#enterprise-customization)
- [Enterprise Build Guide](../enterprise/enterprise-build.md) (if exists)

### For Developers

🔧 **Setup & Configuration:**
- [Quick Start](../developers/new-features.md#quick-start)
- [Configuration Examples](../developers/new-features.md#configuration)
- [Migration Guide](../developers/new-features.md#migration-guide)

⚡ **Quick Reference:**
- [Command Updates](../developers/quick-reference.md#command-updates)
- [Common Patterns](../developers/quick-reference.md#common-patterns)
- [Troubleshooting](../developers/new-features.md#troubleshooting)

🎓 **Learning:**
- [Real-World Scenario](../developers/scenario-context-aware-docs.md)
- [Feature Examples](../developers/new-features.md#usage-examples)
- [Best Practices](../developers/new-features.md#best-practices)

### For Engineering Leaders

📈 **Metrics & Impact:**
- [Measurable Impact](../developers/context-aware-docs-benefits.md#measurable-impact)
- [Success Metrics](../developers/context-aware-docs-benefits.md#success-metrics)
- [Before/After Comparison](../developers/scenario-context-aware-docs.md#sarahs-first-week-side-by-side-comparison)

🎯 **Team Benefits:**
- [Onboarding Impact](../developers/context-aware-docs-benefits.md#educational-value)
- [Senior Developer Time Savings](../developers/scenario-context-aware-docs.md#real-impact-at-techcorp)
- [Code Quality Improvements](../decision-makers/comparison.md#roi-comparison)

### For Security Teams

🛡️ **Security Features:**
- [Forbidden File Protection](../developers/new-features.md#2--forbidden-file-protection)
- [Security Scenario](../developers/scenario-context-aware-docs.md#day-2-first-commit-attempt-200-pm)
- [Sensitive Code Detection](../decision-makers/comparison.md#3-sensitive-code-detection)
